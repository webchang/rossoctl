...
The Rossoctl installer deploys a comprehensive agentic platform across multiple Kubernetes namespaces, creating a secure, scalable environment for running AI agents and tools. The following diagram illustrates the cluster-wide architecture and how components are organized:
...
│  │  ┌────────────┐  ┌────────────┐  ┌────────────┐  ┌────────────┐ │  │
│  │  │ Rossoctl UI │  │  Agent     │  │  Ingress   │  │   Kiali    │ │  │
│  │  │            │  │  Lifecycle │  │  Gateway   │  │            │ │  │
│  │  │            │  │  Operator  │  │            │  │            │ │  │
│  │  └────────────┘  └────────────┘  └────────────┘  └────────────┘ │  │
│  └─────────────────────────────────────────────────────────────────┘  │
...
**Platform Services (`rossoctl-system`):**
- **Rossoctl UI**: Web-based dashboard for managing agents, tools, and monitoring platform health
